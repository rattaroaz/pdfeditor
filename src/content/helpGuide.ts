    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Rotate / Delete — permanent page rotation or removal (at least one page must remain).",
        ],
      },
      {
        type: "tip",
        text: "View → Rotate clockwise/counter-clockwise rotates the view only. Thumbnail panel rotation changes the saved page orientation.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Continuous scroll / Single page / Two-page spread — reading layout.",
